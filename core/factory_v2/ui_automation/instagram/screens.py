...
def build_instagram_detector() -> ScreenDetector:
    return ScreenDetector([
        ...
        _protected("ACCOUNT_RECOVERY", "account_recovery", "Recover your account", "Account recovery", priority=17),
        _protected("CONSENT_WITH_SECURITY_IMPACT", "security_consent", "Two-factor authentication", "Review security settings", priority=18),
        ...
        ScreenSignature("IG_ACCOUNTS_CENTER_CONSENT", PACKAGE, (ACCOUNTS_CENTER_TITLE, ACCOUNTS_CENTER_ALLOW), 2, 0.99, False, 73),
        ScreenSignature("IG_USERNAME_UNAVAILABLE", PACKAGE, (CREATE_USERNAME_TITLE, USERNAME_ENTRY_INPUT, USERNAME_UNAVAILABLE_MARKER), 3, 0.99, False, 74),
        ScreenSignature("IG_USERNAME_VALID", PACKAGE, (CREATE_USERNAME_TITLE, USERNAME_ENTRY_INPUT, USERNAME_VALID_MARKER, CONTINUE), 4, 0.99, False, 75),
        ScreenSignature("IG_USERNAME_ENTRY", PACKAGE, (CREATE_USERNAME_TITLE, USERNAME_ENTRY_INPUT, CONTINUE), 3, 0.97, False, 76),
        ScreenSignature("IG_AVATAR_SETUP", PACKAGE, (ADD_PROFILE_PHOTO,), 1, 0.96, False, 77),
        ScreenSignature("IG_BIRTHDAY_ENTRY", PACKAGE, (BIRTH_DATE_INPUT, CONTINUE), 2, 0.96, False, 78),
        ScreenSignature("IG_CONTACT_ENTRY", PACKAGE, (SIGNUP_CONTACT_INPUT, CONTINUE), 2, 0.96, False, 79),
